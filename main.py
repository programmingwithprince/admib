...
class SimpleApp(MDApp):
    ...
    ads = KivMob('ca-app-pub-9437698423602223~4039568774') # put your Admob Id in case you want to put your own ads.

    points = NumericProperty(0)

    def build(self):

        self.ads.new_banner('ca-app-pub-9437698423602223/3584079686',False)

        self.ads.request_banner()

        self.ads.show_banner()

        self.ads.new_interstitial('ca-app-pub-9437698423602223/4145190846')

        self.ads.load_rewarded_ad('ca-app-pub-9437698423602223/4948681215')
